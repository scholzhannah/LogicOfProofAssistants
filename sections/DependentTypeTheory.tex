...
\begin{rem}
    We could have also used \AxiomC{}\UnaryInfC{$\Gamma \vdash \prod_{A : \typeu{u}}\prod{x : A}x \mathrel{=_A} x$}\DisplayProof as the introduction rule in the above definition. 
\end{rem}
